...
struct Dddmp_Hdr_s {
  ...
  int nVars;
  int nsuppvars;
  // DFA 28-09-2019 Write ALL variable names
  char **varnames;
  // END DFA
...
extern int DddmpIsVisitedAdd(DdNode *f);
...
extern int DddmpIsVisitedBdd(DdNode *f);
...
extern int DddmpIsVisitedCnf(DdNode *f);
